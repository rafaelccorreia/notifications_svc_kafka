...
let NotificationsController = class NotificationsController {
    ...
    async getFromRecipient(recipientId) {
        ...
        return {
            notifications: notifications.map(notification_view_model_1.NotificationViewMode.toHTTP),
        };
    }
    async read(id) {
    ...
    async create(body) {
        ...
        return {
            notification: notification_view_model_1.NotificationViewMode.toHTTP(notification),
        };
    }
};
__decorate([
